...
@section('title', 'Potensi Desa - Seni Budaya')
    ...
    <div class="container  mt-5  mb-5" data-aos="fade-up">
      <div class="row g-5 ">
        ...
        <div class="col-lg-12 col-md-6 content d-flex flex-column justify-content-center order-last order-md-first">
          <h3><em>Potensi Desa - Seni Budaya</em> </h3>
          <div class="row gy-4 posts-list mt-3">
            ...
            <div class="col-sm-3">
              <article class="d-flex flex-column">
                ...
                <h2 class="title">
                  <a href="{{route('detail_senibudaya', $data->slug)}}">{{$data->judul}}</a>
                </h2>
                ...
                <div class="read-more mt-auto align-self-end">
                  <a href="{{route('detail_senibudaya', $data->slug)}}">Read More</a>
                </div>
