  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Karang Taruna</h4>
        <a href=" {{route('karang_taruna.create')}} " class="btn btn-md btn-outline-primary">Tambah Data Karang Taruna</a>
      </div>
      <div class="card-body">
        @if($karangtaruna[0])
        <div class="table-responsive">
          <table class="table">
            ...
            <tbody>
              <?php $no = 1  ?>
              @foreach($karangtaruna as $aparatur)
              <tr style="color: black;">
                ...
                <td>
                  ...
                  <a href="{{route('karang_taruna.edit', $aparatur->id)}}" class="btn btn-sm btn-warning text-white">Edit</a>
                  <form method="POST" action="{{ route('karang_taruna.destroy', $aparatur->id) }}" style="display: inline-block;">
                    @csrf
                    @method('DELETE')
