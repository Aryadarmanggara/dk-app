...
@section('title', 'Tambah Data Aparatur Desa')
  ...
  <div class="col-md-12">
    <div class="card text-white bg-secondary">
      ...
      <div class="card-body mb-0">
        <form action="{{ route('aparatur_desa.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control input-default" id="nip" name="nip" value="{{ old('nip') }}">
          </div>
          <div class="form-group">
