...
@section('title', 'Tambah Data Usaha Mikro')
  ...
  <div class="col-md-12">
    <div class="card text-white bg-secondary">
      <div class="card-header">
        <h5 class="card-title text-white">Tambah Data Usaha Mikro</h5>
      </div>
      <div class="card-body mb-0">
        <form action="{{ route('usahamikro.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
