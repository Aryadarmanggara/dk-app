  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Linmas</h4>
        <a href=" {{route('linmas.create')}} " class="btn btn-md btn-outline-primary">Tambah Data Linmas</a>
      </div>
      <div class="card-body">
        @if($linmas[0])
            ...
            <tbody>
              ...
              <tr style="color: black;">
                ...
                <td>
                  ...
                  <a href="{{route('linmas.edit', $aparatur->id)}}" class="btn btn-sm btn-warning text-white">Edit</a>
                  <form method="POST" action="{{ route('linmas.destroy', $aparatur->id) }}" style="display: inline-block;">
                    @csrf
                    @method('DELETE')
