...
@section('title', 'Potensi Desa - Alam')
          ...
          <div class="row gy-4 posts-list mt-3">
            ...
            <div class="col-sm-3">
              <article class="d-flex flex-column">
                ...
                <h2 class="title">
                  <a href="{{route('detail_alam', $data->slug)}}">{{$data->judul}}</a>
                </h2>
                ...
                <div class="read-more mt-auto align-self-end">
                  <a href="{{route('detail_alam', $data->slug)}}">Read More</a>
                </div>
